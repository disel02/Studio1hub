...
public class PaymentMasterFragment extends Fragment {

    public static final String MY_PREFS_NAME = "MyPrefsFile";
    SharedPreferences.Editor editor;
    Fragment fragment=null;
    String login,isbtnclick,fromnav,payment_method;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_payment_master,null);
    }
        ...
        lvpayment.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                String lid = ((TextView) view.findViewById(R.id.tvpyid)).getText().toString();
                    fragment = new ProjectPaymentMasterFragment();
    ...
    public void getAllList()
    {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    for (int i = 0; i < jsonArray.length(); i++) {
                        ...
                        subjects.Spyid = jsonObject.getString("uID");
        ...
        AdminAllPaymentRequest adminAllPaymentRequest = new AdminAllPaymentRequest(responseListner);
        RequestQueue queue = Volley.newRequestQueue(getActivity());
        queue.add(adminAllPaymentRequest);
    }
